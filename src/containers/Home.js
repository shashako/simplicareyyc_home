           ...
           <Container className = "container marketing">
                <Row>
                  <Col className="col-lg-4">
                    <img className="rounded-circle" src="./images/home/heading1.jpg" alt="Generic placeholder image" width="140" height="140"></img>
                  ...
                  <Col className="col-lg-4">
                    <img className="rounded-circle" src="./images/home/heading2.jpg" alt="Generic placeholder image" width="140" height="140"></img>
                  ...
                  <Col className="col-lg-4">
                    <img className="rounded-circle" src="./images/home/heading3.jpg" alt="Generic placeholder image" width="140" height="140"></img>
                    <h2>Symptoms</h2>
